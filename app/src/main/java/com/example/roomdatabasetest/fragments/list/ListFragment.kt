package com.example.roomdatabasetest.fragments.list
...
class ListFragment : Fragment() {
    ...
    private fun deleteAllUsers() {
        ...
        builder.setPositiveButton("Yes") {_, _ ->
            ...
            Toast.makeText(requireContext(), "Removed everything.", Toast.LENGTH_LONG).show()
            mUserViewModel.resertCounter()
        }
